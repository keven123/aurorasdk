...
public class Jsr199CompilationProblem implements CompilationProblem {
    ...
    public int getEndColumn() {
        ...
        return (int)problem.getEndPosition();
    }
    ...
    public String getFileName() {
        // TODO Auto-generated method stub
        return problem.getSource().getName();
    }

    public String getMessage() {
        // TODO Auto-generated method stub
        return problem.getMessage(null).substring(
        		problem.getMessage(null).lastIndexOf(
        				problem.getLineNumber()+":")+3);
    }

    public int getStartColumn() {
        // TODO Auto-generated method stub
        return (int)problem.getStartPosition();
    }
    ...
    public boolean isError() {
        // TODO Auto-generated method stub
    	if(problem.getKind().toString().equalsIgnoreCase("error"))
    		return true;
    	return false;
    }
